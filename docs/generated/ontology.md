...
Schema version **28**. 28 node types, 15 edge types.
...
| **Visual** | target | §4.1.1 | `page` <br> string, required <br> `type` <br> string, required <br> `source_sheet_ref` <br> string <br> `encodings` <br> json <br> `redesign_flag` <br> bool <br> `redesign_reason` <br> string <br> `layout` <br> json <br> `interactivity` <br> json |
