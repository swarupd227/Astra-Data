...
Schema version **38**. 29 node types, 15 edge types.
...
|---|---|---|---|
| **Site** | source | §4.1.1 | `luid` <br> luid, required <br> `name` <br> string, required <br> `owner` <br> string <br> `user_count` <br> int <br> `licence_cost_annual` <br> float <br> `licence_tier` <br> string <br> `decommissioned_at` <br> timestamp <br> `licence_release_value` <br> float |
