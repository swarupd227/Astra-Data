...
Schema version **27**. 28 node types, 15 edge types.
...
| **ParityCase** | target | §4.1.1, §10 | `mu_ref` <br> string, required <br> `sheet_ref` <br> string, required <br> `grain` <br> string[], required <br> `measures` <br> string[], required <br> `filter_ctx` <br> json <br> `param_values` <br> json <br> `expected_ref` <br> string <br> `candidate_ref` <br> string <br> `state` <br> string <br> `case_key` <br> string, required |
